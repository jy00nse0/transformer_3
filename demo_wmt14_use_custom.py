...
#   --custom: Use CustomMultiheadAttention (d_k/d_v 독립 제어, Table 3(B) 실험용)
#   --d_k: Key/Query dimension per head (--custom과 함께 사용, default: d_model/n_head)
#   --d_v: Value dimension per head (--custom과 함께 사용, default: d_model/n_head)
#
# Example Usage:
...
#
#   # Table 3(B) 실험: Custom Attention으로 d_k=16 학습
#   python demo_wmt14_pretrained.py --load_dir ./artifacts_pretrained \
#       --custom --d_k 16 --d_v 64 --checkpoint_dir checkpoints/table3_b_dk16
#
#   # Table 3(B) 실험: d_k=32
#   python demo_wmt14_pretrained.py --load_dir ./artifacts_pretrained \
#       --custom --d_k 32 --d_v 64 --checkpoint_dir checkpoints/table3_b_dk32
#
# ============================================================================
    ...
    while global_step < args.max_steps:
        ...
        for batch_idx, batch in enumerate(train_iter):
            ...
            if global_step % args.log_every == 0:
                ...
                print(f"Step {global_step:6,}/{args.max_steps:,} ({global_step/args.max_steps*100:5.1f}%) | "
